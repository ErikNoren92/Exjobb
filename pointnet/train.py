...
parser.add_argument('--model', default='pointnet_cls1', help='Model name: pointnet_cls or pointnet_cls_basic [default: pointnet_cls]')
parser.add_argument('--log_dir', default='log', help='Log dir [default: log]')
parser.add_argument('--num_point', type=int, default=128, help='Point Number [256/512/1024/2048] [default: 1024]')
parser.add_argument('--max_epoch', type=int, default=5, help='Epoch to run [default: 250]')
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str('0')):
            ...
            pdb.set_trace()
            # Get model and loss
            architecture, pred, end_points = MODEL.get_model(pointclouds_pl, is_training_pl, bn_decay=bn_decay)
